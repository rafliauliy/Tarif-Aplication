...
<div class="card p-3">
    ...
    <?php echo form_open('approvals/edit/' . $approval['id_approval']); ?>

    <div class="row">
        <div class="col-md-12">
            <div class="form-group">
                <label for="nama_vendor">Nama Vendor</label>
                <input type="text" name="nama_vendor" class="form-control form-control-sm" value="<?php echo set_value('nama_vendor', $approval['nama_vendor']); ?>" />
            </div>
        </div>
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <input type="text" name="muat" class="form-control form-control-sm" value="<?php echo set_value('muat', $approval['muat']); ?>" />
            </div>
        </div>
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <input type="text" name="bongkar" class="form-control form-control-sm" value="<?php echo set_value('bongkar', $approval['bongkar']); ?>" />
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="form-group">
                ...
                <input type="text" name="jenis_cargo" class="form-control form-control-sm" value="<?php echo set_value('jenis_cargo', $approval['jenis_cargo']); ?>" />
            </div>
        </div>
        <div class="col-md-6">
            <div class="form-group">
                <label for="jenis_transportasi">Jenis Moda Transportasi</label>
                <input type="text" name="jenis_transportasi" class="form-control form-control-sm" value="<?php echo set_value('jenis_transportasi', $approval['jenis_transportasi']); ?>" />
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-3">
            <div class="form-group">
                ...
                <input type="text" name="tarif_ritase" id="tarif_ritase" class="form-control form-control-sm" value="<?php echo set_value('tarif_ritase', $approval['tarif_ritase']); ?>" />
            </div>
        </div>
        ...
        <div class="col-md-3">
            <div class="form-group">
                ...
                <input type="number" name="tarif_ritase_persen" id="tarif_ritase_persen" value="<?php echo set_value('tarif_ritase_persen', $approval['tarif_ritase_persen']); ?>" class="form-control form-control-sm" />
            </div>
        </div>
        ...
        <div class="col-md-3">
            <div class="form-group">
                ...
                <input type="text" name="tarif_tonase" id="tarif_tonase" class="form-control form-control-sm" value="<?php echo set_value('tarif_tonase', $approval['tarif_tonase']); ?>" />
            </div>
        </div>
        ...
        <div class="col-md-3">
            <div class="form-group">
                ...
                <input type="number" name="tarif_tonase_persen" id="tarif_tonase_persen" value="<?php echo set_value('tarif_tonase_persen', $approval['tarif_tonase_persen']); ?>" class="form-control form-control-sm" />
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="form-group">
                ...
                <input type="text" id="hasil_ritase" name="hasil_ritase" class="form-control form-control-sm" value="<?php echo set_value('hasil_ritase', $approval['hasil_ritase']); ?>" readonly />
            </div>
        </div>
        <div class="col-md-6">
            <div class="form-group">
                <label for="hasil_tonase">Hasil Tarif Pertonase</label>
                <input type="text" id="hasil_tonase" name="hasil_tonase" class="form-control form-control-sm" value="<?php echo set_value('hasil_tonase', $approval['hasil_tonase']); ?>" readonly />
            </div>
        </div>
